...
bool valid_player_combination(AccountStatus player1, AccountStatus player2) {
    // guests are not allowed to play
    if (player1 == AccountStatus::troll && player2 == AccountStatus::troll) {
        return true;
    } else if (player1 == AccountStatus::user && player2 > AccountStatus::guest) {
        return true;
    } else if (player1 == AccountStatus::mod && player2 > AccountStatus::guest) {
        return true;
    }
    return false;
}
